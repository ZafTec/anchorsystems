...
const Hero = () => {
    return (
        <div className="relative overflow-hidden bg-slate-950 py-20 sm:py-32">
                    ...
                    <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                        <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                            ...
                            <Link
                                ...
                                className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-teal-400 bg-slate-900 border-teal-400 hover:bg-slate-800 md:py-4 md:text-lg md:px-10 transition-colors"
                            >
                                Discover RAG
                            </Link>
                        </div>
