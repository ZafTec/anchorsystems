        ...
        <div className="bg-slate-900 py-16" id="contact">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {submitStatus === 'success' && (
                    <div className="mb-6 p-4 bg-teal-900 border border-teal-500 rounded-lg text-teal-100">
                        ✓ Thank you! Your message has been sent successfully. We&apos;ll be in touch soon.
                    </div>
                )}

                {submitStatus === 'error' && (
                    <div className="mb-6 p-4 bg-red-900 border border-red-500 rounded-lg text-red-100">
