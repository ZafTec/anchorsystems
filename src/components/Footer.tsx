...
const Footer = () => {
    return (
        <footer className="bg-slate-100 dark:bg-slate-950 text-slate-600 dark:text-gray-400 py-12 border-t border-slate-200 dark:border-slate-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        <Link href="/" className="text-2xl font-bold text-slate-900 dark:text-white mb-4 block">
                            Anchor Systems
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link href="/services/llm-chatbot" className="hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                                    LLM Chatbots
                                </Link>
                            </li>
                            <li>
                                <Link href="/services/rag-systems" className="hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                                    RAG Systems
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-900 text-sm text-center">
