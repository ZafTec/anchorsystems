        ...
        <div className="py-24 bg-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-base text-teal-400 font-semibold tracking-wide uppercase">Our Expertise</h2>
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
                        {features.map((feature) => (
                            <div key={feature.name} className="relative group">
                                ...
                                <div className="relative p-8 bg-slate-950 ring-1 ring-slate-800 rounded-lg leading-none flex items-top justify-start space-x-6">
                                    <div className="flex-shrink-0">
                                        <div className="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-r from-blue-500 to-teal-500 text-white">
                                            {feature.icon}
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <Link href={feature.href} className="text-teal-400 hover:text-teal-300 font-medium inline-flex items-center transition-colors">
                                            Learn more
