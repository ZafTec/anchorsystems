        ...
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mb-12">
                    <Link
                        href="/"
                        className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors mb-4 inline-block"
                    >
                        ← Back to Home
                    </Link>
                    <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-100 mt-4 mb-4">Privacy Policy</h1>
                ...
                <div className="prose prose-slate dark:prose-invert max-w-none">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                            ...
                            you visit our website <a href="https://anchorsystems.ai" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">anchorsystems.ai</a>
                    ...
                    <section className="mb-10">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">2.1 Information You Provide to Us</h3>
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">2.2 Information Collected Automatically</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">2.3 Client Project Data</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4">
                            <strong className="text-indigo-600 dark:text-indigo-400">Important:</strong> Client project data remains your property.
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">4. How We Share Your Information</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                            We do not sell, trade, or rent your personal information to third parties. We may share your information only in the following limited circumstances:
                        </p>

                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">4.1 Service Providers</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">4.2 LLM Providers (For Client Projects)</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4 mb-6">
                            <strong className="text-indigo-600 dark:text-indigo-400">Data Protection Guarantee:</strong> We configure all LLM integrations
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">4.3 Legal Requirements</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                            We may disclose your information if required by law or in response to valid legal requests
                            (e.g., court orders, subpoenas, government investigations).
                        </p>

                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">4.4 Business Transfers</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4">
                            <strong className="text-amber-600 dark:text-amber-400">Note:</strong> While we use commercially reasonable security measures,
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">6. Cookies and Tracking Technologies</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                            We use cookies and similar tracking technologies to improve your experience on our website:
                        </p>

                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">6.1 Types of Cookies We Use</h3>
                        <ul className="list-disc list-inside space-y-2 mb-6 text-slate-600 dark:text-slate-400">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">6.2 Managing Cookies</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                    ...
                    {/* Your Privacy Rights */}
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">9. Your Privacy Rights</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                            Depending on your location, you may have the following rights regarding your personal information:
                        </p>

                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">9.1 General Rights</h3>
                        <ul className="list-disc list-inside space-y-2 mb-6 text-slate-600 dark:text-slate-400">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">9.2 GDPR Rights (EU/EEA Residents)</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">9.3 CCPA Rights (California Residents)</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
                        ...
                        <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">9.4 How to Exercise Your Rights</h3>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                            To exercise any of these rights, please contact us at{' '}
                            <a href="mailto:contact@anchorsystems.ai" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
                    ...
                    {/* Third-Party Links */}
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">10. Third-Party Links</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                    ...
                    {/* Children's Privacy */}
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">11. Children&apos;s Privacy</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">12. Changes to This Privacy Policy</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-6">
                            <p className="text-slate-600 dark:text-slate-400 mb-2">
                                <strong className="text-slate-900 dark:text-slate-100">Anchor Systems</strong>
                            </p>
                            <p className="text-slate-600 dark:text-slate-400 mb-2">
                                <strong>Email:</strong>{' '}
                                <a href="mailto:contact@anchorsystems.ai" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
                            ...
                            <p className="text-slate-600 dark:text-slate-400 mb-2">
                                ...
                                <a href="https://anchorsystems.ai" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
                                    anchorsystems.ai
                                </a>
                            </p>
                            <p className="text-slate-600 dark:text-slate-400">
                    ...
                    {/* Consent */}
                    <section className="mb-10">
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">14. Consent</h2>
                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                    ...
                    {/* Summary Box */}
                    <div className="bg-indigo-100 dark:bg-indigo-900/20 border-2 border-indigo-300 dark:border-indigo-500/50 rounded-xl p-6 mt-12">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3">Privacy at a Glance</h3>
